            ...
            <div className="py-16 md:py-32">
                <div className="mx-auto max-w-6xl px-6">
                    <div className="text-center">
                       <h2 className="text-title text-3xl md:text-4xl font-semibold">
   Satisfied Clients
</h2>
<p className="text-gray-600 mt-6 max-w-3xl mx-auto">
  Our commitment to quality, precision, and timely project delivery has earned the trust of clients across commercial, industrial, and infrastructure sectors.
</p>
