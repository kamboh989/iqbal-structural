...
const ProcessCard: React.FC<ProcessCardProps> = ({ icon: Icon, title, description, className }) => (
  <div className={cn("group relative w-full rounded-lg border border-gray-200 hover:border-gray-500 bg-card p-6 transition-all duration-300 hover:border-primary/60 hover:shadow-3xl ", className)}>
    ...
    {/* Icon Container */}
    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg duration-300 border bg-background text-orange-600 shadow-sm transition-colors group-hover:bg-primary group-hover:text-primary-foreground">
